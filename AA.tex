...
\begin{example}\ 
    \begin{problem}
        Let $\vec{F}(x,y,z) = \begin{colvector}x\\y\\z\end{colvector}$ and $S = \{(x,y,z)\suchthat x^2+y^2+z^2=1\}$. Let $S$ be oriented such that the normal
    ...
    \begin{solution}
        ...
        \]
        \begin{flalign*}
            \vec{r}(u,v) &= \begin{colvector}\sin{v}\cos{u}\\\sin{v}\sin{u}\\\cos{v}\end{colvector} &&\\
            \parderiv{\vec{r}}{u} &= \begin{colvector}-\sin{u}\sin{v}\\\cos{u}\sin{v}\\0\end{colvector} &&\\
            \parderiv{\vec{r}}{v} &= \begin{colvector}\cos{u}\cos{v}\\\sin{u}\cos{v}\\-\sin{v}\end{colvector} &&\\
            \parderiv{\vec{r}}{u} \times \parderiv{\vec{r}}{v} &= \begin{colvector}-\cos{u}\sin^2{v}\\-\sin{u}\sin^2{v}\\-\sin{v}\cos{v}\end{colvector} &&\\
            &= -\sin{\!(v)}\vec{r}(u,v)&&
        \end{flalign*}
